...
function $confirm(sMsg, yesObj, noObj) {
    ...
    if (jMesbook1.length == 0) {
        var sHtml = "<div id='mesbook1_c'>"
				+ "<div><img onclick='hideMsg()' id='mesbook1_cImgClose' src='" + SKIN_PATH + "img/index/ico9_close.gif' alt='关闭' class='fr p vam' /><span id='mesbook1_cTitle'></span></div>"
				+ "<dl class='b1'>"
					+ "<dt><img id='mesbook1_cIcon' src='" + SKIN_PATH + "img/index/message_ico_03.gif' alt='' title=''  /></dt>"
    ...
    //图标
    var iconPath = SKIN_PATH + "img/index/ico_ques.gif";
...
function $a(sMsg, boxType, autoClose, focusElmId, sTitle, behavior) {
    ...
    if (jMesbook1.length == 0) {
        var sHtml = "<div id='mesbook1'>"
				+ "<div><img style='float:right' onclick='hideMsg()' id='mesbook1ImgClose' src='" + SKIN_PATH + "img/index/ico9_close.gif' alt='关闭' class='fr p vam ml5' /><span id='mesbook1Title'></span></div>"
				+ "<dl class='b1'>"
					+ "<dt><img id='mesbook1Icon' src='" + SKIN_PATH + "img/index/message_ico_03.gif' alt='' title='' /></dt>"
    ...
    jMesbook1Msg.html(sMsg);
    //图标
    var iconPath = SKIN_PATH + "img/index/";
    switch (boxType) {
