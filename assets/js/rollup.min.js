...
jQuery(document).ready(function ($) {
    include_file("/assets/css/resetcommonindex.css", "css", function () {
                if (!IsLoads("/assets/js/jquery-1.3.2.min.js")) {
                    include_file("/assets/js/jquery-1.3.2.min.js", "script", action)
                } else {
                    action()
                }
        action();
